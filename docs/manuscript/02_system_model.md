...
A reservation is released only after the execution promise settles. Thus cancellation requests interruption, but it does not make capacity available while the underlying agent operation is still pending.
