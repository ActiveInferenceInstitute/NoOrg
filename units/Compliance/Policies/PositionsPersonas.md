# Compliance - Positions & Personas

## Overview

This document defines the key positions and personas within the Compliance unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Compliance | Director | Executive Leadership | All Compliance staff |
| Senior Compliance Lead | Manager | Head of Compliance | Team leads and specialists |
| Compliance Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Compliance Specialist | IC3 | Complex initiatives, mentoring |
| Compliance Specialist | IC2 | Core operational activities |
| Compliance Analyst | IC1 | Research, analysis, support |
| Compliance Coordinator | IC1 | Administrative coordination |
