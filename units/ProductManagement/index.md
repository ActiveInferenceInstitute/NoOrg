...
The Product Management unit provides strategic and operational leadership in product management-related activities across the organization.

## Mission

To deliver excellence through expert guidance, efficient processes, and continuous improvement in product management.
...
| Role | Responsibility |
|------|----------------|
| Head of Product Management | Strategic direction and oversight |
| Product Management Manager | Operational management |
| Product Management Lead | Team coordination |
| Product Management Specialist | Subject matter expertise |
