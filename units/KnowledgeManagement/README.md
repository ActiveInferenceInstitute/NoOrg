...
The Knowledge Management unit is responsible for knowledge management-related strategy, operations, and stakeholder support across the organization.

## Mission

To deliver excellence in knowledge management by providing strategic guidance, operational efficiency, and continuous improvement.
...
| Role | Responsibility |
|------|----------------|
| Head of Knowledge Management | Strategic direction and oversight |
| Knowledge Management Manager | Operational management |
| Knowledge Management Lead | Team coordination |
