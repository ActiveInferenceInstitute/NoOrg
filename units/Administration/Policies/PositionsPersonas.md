# Administration - Positions & Personas

## Overview

This document defines the key positions and personas within the Administration unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Administration | Director | Executive Leadership | All Administration staff |
| Senior Administration Lead | Manager | Head of Administration | Team leads and specialists |
| Administration Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Administration Specialist | IC3 | Complex initiatives, mentoring |
| Administration Specialist | IC2 | Core operational activities |
| Administration Analyst | IC1 | Research, analysis, support |
| Administration Coordinator | IC1 | Administrative coordination |
