# Education - Positions & Personas

## Overview

This document defines the key positions and personas within the Education unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Education | Director | Executive Leadership | All Education staff |
| Senior Education Lead | Manager | Head of Education | Team leads and specialists |
| Education Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Education Specialist | IC3 | Complex initiatives, mentoring |
| Education Specialist | IC2 | Core operational activities |
| Education Analyst | IC1 | Research, analysis, support |
| Education Coordinator | IC1 | Administrative coordination |
