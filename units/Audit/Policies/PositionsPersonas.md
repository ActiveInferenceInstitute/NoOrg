# Audit - Positions & Personas

## Overview

This document defines the key positions and personas within the Audit unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Audit | Director | Executive Leadership | All Audit staff |
| Senior Audit Lead | Manager | Head of Audit | Team leads and specialists |
| Audit Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Audit Specialist | IC3 | Complex initiatives, mentoring |
| Audit Specialist | IC2 | Core operational activities |
| Audit Analyst | IC1 | Research, analysis, support |
| Audit Coordinator | IC1 | Administrative coordination |
