# Audit Meeting Notes - AI Agent Configuration

## Overview

Technical documentation and AI agent configuration for meeting note artifacts within the Audit unit.
...
- [Audit Overview](../README.md)
- [Audit Charter](../Charter.md)
