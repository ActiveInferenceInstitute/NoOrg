...
- **Sales / Business Development:** Contracts here should link to or reference corresponding deals or opportunities managed by Sales/BD.
  - *Example Link Pending reference:* [Project Falcon MSA](./Executed_Agreements/Project_Falcon_MSA.md) - See [Sales Deal Record](../../Sales/Deals/Falcon_Deal_ID_123.md) <!-- Update path as needed -->
