...
This section provides comprehensive documentation for contracts activities, including policies, procedures, and key artifacts.
...
| Role | Responsibility |
|------|----------------|
| Contracts Lead | Overall oversight and guidance |
| Contracts Specialist | Day-to-day operations |
