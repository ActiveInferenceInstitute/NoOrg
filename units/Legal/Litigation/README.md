...
- **Internal Incidents/Investigations:** Litigation files should link to relevant internal investigation reports or incident records (location varies, e.g., HR, Security, Compliance).
  - *Example Link Placeholder:* [Case File: Smith v. Corp](../../../README.md) - Related to [Internal Incident Report #HR-2024-05](../../HumanResources/Investigations/HR-2024-05.md) <!-- Update path as needed -->
