# HumanResources Meeting Notes - AI Agent Configuration

## Overview

Technical documentation and AI agent configuration for meeting note artifacts within the HumanResources unit.
...
- [HumanResources Overview](../README.md)
- [HumanResources Charter](../Charter.md)
