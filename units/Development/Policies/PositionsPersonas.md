# Development - Positions & Personas

## Overview

This document defines the key positions and personas within the Development unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Development | Director | Executive Leadership | All Development staff |
| Senior Development Lead | Manager | Head of Development | Team leads and specialists |
| Development Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Development Specialist | IC3 | Complex initiatives, mentoring |
| Development Specialist | IC2 | Core operational activities |
| Development Analyst | IC1 | Research, analysis, support |
| Development Coordinator | IC1 | Administrative coordination |
