# QualityAssurance Meeting Notes - AI Agent Configuration

## Overview

Technical documentation and AI agent configuration for meeting note artifacts within the QualityAssurance unit.
...
- [QualityAssurance Overview](../README.md)
- [QualityAssurance Charter](../Charter.md)
