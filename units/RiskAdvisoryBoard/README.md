...
- **Processes/**: Outlines key operational processes, including:
    ...
    - [Advisory Recommendation Process](Processes/AGENTS.md) (To be created)
    - [Meeting Cadence and Agenda Process](Processes/AGENTS.md) (To be created)
- **MeetingNotes/**: Contains minutes and records from RAB meetings. (Pending reference)
- **Reports/**: Contains reports generated by or for the RAB. (Pending reference)
