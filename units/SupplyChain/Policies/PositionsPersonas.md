# Supply Chain - Positions & Personas

## Overview

This document defines the key positions and personas within the Supply Chain unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Supply Chain | Director | Executive Leadership | All Supply Chain staff |
| Senior Supply Chain Lead | Manager | Head of Supply Chain | Team leads and specialists |
| Supply Chain Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Supply Chain Specialist | IC3 | Complex initiatives, mentoring |
| Supply Chain Specialist | IC2 | Core operational activities |
| Supply Chain Analyst | IC1 | Research, analysis, support |
| Supply Chain Coordinator | IC1 | Administrative coordination |
