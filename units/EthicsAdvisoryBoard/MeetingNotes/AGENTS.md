# EthicsAdvisoryBoard Meeting Notes - AI Agent Configuration

## Overview

Technical documentation and AI agent configuration for meeting note artifacts within the EthicsAdvisoryBoard unit.
...
- [EthicsAdvisoryBoard Overview](../README.md)
- [EthicsAdvisoryBoard Charter](../Charter.md)
