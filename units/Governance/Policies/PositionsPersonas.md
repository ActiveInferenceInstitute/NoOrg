# Governance - Positions & Personas

## Overview

This document defines the key positions and personas within the Governance unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Governance | Director | Executive Leadership | All Governance staff |
| Senior Governance Lead | Manager | Head of Governance | Team leads and specialists |
| Governance Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Governance Specialist | IC3 | Complex initiatives, mentoring |
| Governance Specialist | IC2 | Core operational activities |
| Governance Analyst | IC1 | Research, analysis, support |
| Governance Coordinator | IC1 | Administrative coordination |
