# Facilities - Positions & Personas

## Overview

This document defines the key positions and personas within the Facilities unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Facilities | Director | Executive Leadership | All Facilities staff |
| Senior Facilities Lead | Manager | Head of Facilities | Team leads and specialists |
| Facilities Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Facilities Specialist | IC3 | Complex initiatives, mentoring |
| Facilities Specialist | IC2 | Core operational activities |
| Facilities Analyst | IC1 | Research, analysis, support |
| Facilities Coordinator | IC1 | Administrative coordination |
