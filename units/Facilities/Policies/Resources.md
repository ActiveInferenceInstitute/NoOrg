...
This document catalogs the tools, systems, templates, and external resources available to the Facilities unit.

## Internal Systems

| System | Purpose | Access Level |
|--------|---------|--------------|
| Document Management | Policy and procedure storage | All Facilities staff |
| Project Tracking | Initiative management | Managers and above |
| Reporting Dashboard | Metrics and KPIs | All Facilities staff |
