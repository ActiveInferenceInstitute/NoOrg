# MetaGovernance Meeting Notes - AI Agent Configuration

## Overview

Technical documentation and AI agent configuration for meeting note artifacts within the MetaGovernance unit.
...
- [MetaGovernance Overview](../README.md)
- [MetaGovernance Charter](../Charter.md)
