# Procurement Meeting Notes - AI Agent Configuration

## Overview

Technical documentation and AI agent configuration for meeting note artifacts within the Procurement unit.
...
- [Procurement Overview](../README.md)
- [Procurement Charter](../Charter.md)
