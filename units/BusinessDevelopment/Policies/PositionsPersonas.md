# Business Development - Positions & Personas

## Overview

This document defines the key positions and personas within the Business Development unit. Each role has specific responsibilities, required competencies, and interaction patterns.
...
|----------|-------|------------|----------------|
| Head of Business Development | Director | Executive Leadership | All Business Development staff |
| Senior Business Development Lead | Manager | Head of Business Development | Team leads and specialists |
| Business Development Manager | Manager | Senior Lead | Analysts and coordinators |

### Individual Contributor Roles

| Position | Level | Focus Area |
|----------|-------|------------|
| Senior Business Development Specialist | IC3 | Complex initiatives, mentoring |
| Business Development Specialist | IC2 | Core operational activities |
| Business Development Analyst | IC1 | Research, analysis, support |
| Business Development Coordinator | IC1 | Administrative coordination |
