...
exports.runThinOrchestrationExample = runThinOrchestrationExample;
exports.runEventDrivenExample = runEventDrivenExample;
exports.runBatchProcessingExample = runBatchProcessingExample;
exports.runStateBasedExample = runStateBasedExample;
exports.runPriorityDistributionExample = runPriorityDistributionExample;
exports.runRealTimeEventExample = runRealTimeEventExample;
...
async function runThinOrchestrationExample() {
    ...
    // Create coordinator
    const coordinator = new MultiAgentCoordinator_1.MultiAgentCoordinator('Thin Orchestrator');
    try {
...
async function runEventDrivenExample() {
    ...
    const coordinator = new MultiAgentCoordinator_1.MultiAgentCoordinator('Event Driven Orchestrator');
    try {
        await coordinator.initialize();
        await coordinator.start();
...
async function runBatchProcessingExample() {
    ...
    const coordinator = new MultiAgentCoordinator_1.MultiAgentCoordinator('Batch Processor');
    try {
        await coordinator.initialize();
        await coordinator.start();
...
async function runStateBasedExample() {
    ...
    const coordinator = new MultiAgentCoordinator_1.MultiAgentCoordinator('State-Based Orchestrator');
...
async function runPriorityDistributionExample() {
    ...
    const coordinator = new MultiAgentCoordinator_1.MultiAgentCoordinator('Priority Orchestrator');
    try {
        await coordinator.initialize();
        await coordinator.start();
        ...
        const tasks = [
            { name: 'Critical Security Update', priority: 'critical', type: 'complex-processing' },
            { name: 'User Data Backup', priority: 'high', type: 'complex-processing' },
            { name: 'Report Generation', priority: 'medium', type: 'standard-processing' },
            { name: 'Cache Cleanup', priority: 'low', type: 'background-processing' },
            { name: 'Log Analysis', priority: 'medium', type: 'standard-processing' },
            { name: 'System Health Check', priority: 'low', type: 'background-processing' }
        ];
        const taskIds = [];
        for (const task of tasks) {
            const taskId = await coordinator.createTask({
...
async function runRealTimeEventExample() {
    ...
    const coordinator = new MultiAgentCoordinator_1.MultiAgentCoordinator('Real-time Orchestrator');
    const sharedState = SharedStateManager_1.SharedStateManager.getInstance();
    try {
        await coordinator.initialize();
        await coordinator.start();
...
//# sourceMappingURL=thin_orchestration_example.js.map