...
exports.ProjectConfigGenerator = void 0;
...
class ProjectConfigGenerator {
    ...
    constructor(apiKey) {
        ...
        Object.defineProperty(this, "cacheEnabled", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
     ...
     */
    async generateConfig(domain, objective, options = {}) {
     ...
     */
    async generateObjective(domain) {
        try {
...
Respond with just the objective text, no additional commentary.`;
     ...
     */
    async generateConfigElements(domain, objective) {
        try {
...
Format as JSON with these fields:
{
  ...
  "targetUsers": "Comma-separated list of target user groups"
    ...
    static async example() {
        ...
        const config2 = await generator.generateConfig('Healthcare Technology', 'Develop a remote patient monitoring system for chronic disease management');
        console.log('\nConfig 2 (provided objective):');
        console.log(config2);
        // Example 3: Generate with custom options
        const config3 = await generator.generateConfig('Education Technology', 'Create an adaptive learning platform for K-12 mathematics', {
...
exports.ProjectConfigGenerator = ProjectConfigGenerator;
//# sourceMappingURL=ProjectConfigGenerator.js.map