...
const RateLimiter_1 = require("../../../src/core/integration/patterns/RateLimiter");
...
describe('RateLimiter Pattern', () => {
    ...
    beforeEach(() => {
        ...
        rateLimiter = new RateLimiter_1.RateLimiter('test-limiter', {
            requestsPerPeriod: 2,
            periodInMs: 100,
            maxQueueSize: 5,
            queueTimeout: 500
    ...
    test('should use static getInstance method correctly', async () => {
        const instance1 = RateLimiter_1.RateLimiter.getLimiter('shared-limiter', {
            requestsPerPeriod: 3,
            periodInMs: 100
        });
        const instance2 = RateLimiter_1.RateLimiter.getLimiter('shared-limiter');
...
//# sourceMappingURL=RateLimiterTest.js.map